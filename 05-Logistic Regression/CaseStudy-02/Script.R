...
setwd("/Users/wilbe/OneDrive/Documentos/GoogleDrive/Estudos/FIA/Estat�stica Aplicada/Aula 17 e 18")
getwd()
...
# **********************************************************
# (d) Rode a regressão Log�stica considerando as covariáveis categorizadas. Identifique quais variáveis foram selecionadas pelo modelo, interprete-as, e avalie o desempenho do modelo pela Tabela de Classificação.
...
# Para o modelo log�stico, com a função 'predict', tendo como parâmetro type = 'response' conseguimos obter as probabilidades do modelo para a classificação '1'
...
# **********************************************************
# (e) Rode árvore de decisão usando o método CHAID com 3 n�veis. Identifique quais variáveis foram selecionadas pelo modelo, interprete-as, e avalie o desempenho do modelo pela Tabela de Classificação.
...
# Todas as variáveis como um fator (não como numérico para ser input da �rvore)
telefonia$resposta <- as.factor(telefonia$resposta)
telefonia$Idade_q <- as.factor(telefonia$Idade_q)

# Para a árvore não ficar muito grande, a três n�veis
...
# Incluir na base de dados a probabilidade predita pela �rvore de Decisão
...
# Cria variável resposta predita com base na probabilidade predita pela �rvore de Decisão
...
# �rea abaixo da curva ROC: Regressão Log�stica
roc(telefonia$resposta,
    telefonia$reg_log_p1,
    plot = TRUE,
    legacy.axes = TRUE,
    print.auc = TRUE,
    main = "Regressão Log�stica")

# �rea abaixo da curva ROC: �rvore de Decisão
roc(telefonia$resposta,
    telefonia$P_1_AD,
    plot = TRUE,
    legacy.axes = TRUE,
    print.auc = TRUE,
    main = "�rvore de Decisão")

# **********************************************************
# (i) Construa a tabela de probabilidade preditas x resposta observada em VINTIS para Regressão Log�stica, 
# e obtenha de forma análoga a tabela de probabilidades por nó x resposta para �rvore de Decisão.
# Use a planilha do Excel 'An_Desempenho_Exercicio'.

# Tabela de Desempenho: Regressão Log�stica
# (Use a planilha do Excel 'An_Desempenho_Exercicio')
...
# Propensão dos nós finais: �rvore de Decisão
telefonia$node <- predict(arvore_red1, type = "node")

# Tabela de Desempenho: �rvore de Decisão
